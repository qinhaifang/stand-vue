...
export default {
  ...
  watch: {
    isShowCollectVoucher(flag) {
      if (flag && this.collectType === "Telnet") {
        this.listTeinet[4].encode = this.contextTeinet.encode;
        this.encode = this.contextTeinet.encode;
      }
    },
  },
  mounted() {
    if (this.collectType === "Telnet") {
      this.contextTeinet.encode = getRandom(16);
      this.encode = this.contextTeinet.encode;
    }
  },
  methods: {
